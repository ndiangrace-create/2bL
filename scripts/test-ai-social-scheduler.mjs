...
assert.match(page,/新增宣傳/); assert.match(page,/貼文排程/); assert.match(page,/FB／IG 連接/);
...
for(const action of ['socialCreateCampaign','socialSavePartner','socialGenerateCampaign','socialUpdatePost','socialRegeneratePost','socialRegenerateHashtags','socialRegenerateImagePrompt','socialUploadPostImage','socialScheduleCampaign','socialSelectMetaAccounts']){
