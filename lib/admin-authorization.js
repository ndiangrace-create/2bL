...
export const PLATFORM_ADMIN_ACTIONS = new Set([
  ...
  'socialMetaStatus', 'socialCreateCampaign', 'socialGenerateCampaign', 'socialUploadCampaignReference', 'socialArchiveCampaign',
  'socialUpdatePost', 'socialRegeneratePost', 'socialRegenerateHashtags',
  'socialRegenerateImagePrompt', 'socialUploadPostImage', 'socialGeneratePostImage', 'socialDeletePostImage',
  'socialScheduleCampaign', 'socialCancelPost', 'socialRetryPost',
  'socialSelectMetaAccounts', 'socialRefreshMetaAccounts', 'socialMetaDisconnect', 'socialThreadsDisconnect',
]);
...
export const TENANT_OWNER_ACTIONS = new Set([
  ...
  'saveVenueMap', 'deleteVenueMap', 'adjustMemberCredit',
...
export const SERIES_MANAGER_ACTIONS = new Set([
  ...
  'saveMemberNote', 'saveMemberCategory', 'adminUpdateMemberProfile', 'getMemberEditHistory', 'saveSeatMap', 'adminSeatBoard', 'syncSeatRoster',
